    ...
    <section className="catalog">
      <div className="container">
        ...
        <div className="catalog__title-container"> {/* Добавлен контейнер */}
            ...
            <p>Обеспечение закупок в соответствии с Постановлением Кабинета Министров КР от 10 июня 2022 года № 301 "Об утверждении Типового порядка организации и осуществления закупок государственными и муниципальными предприятиями, хозяйственными обществами, где 50 и более процентов доли участия в уставном капитале принадлежат государству, в том числе их дочерними хозяйственными обществами"</p> {/* Добавлена дополнительная информация */}
          </div>
